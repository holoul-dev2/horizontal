            ...
            <div class="dropdown d-none d-md-block ml-2">
                <button type="button" class="btn header-item waves-effect"
                    ...
                    @if ( Config::get('app.locale') == 'ar')
                        <img src="assets/images/flags/Egyptian.jpg" alt="user-image" class="mr-1" height="12"> <span
                                class="align-middle"> ِArabic </span>
                    @elseif(Config::get('app.locale') == 'en')
                        <img class="mr-2" src="assets/images/flags/us_flag.jpg" alt="Header Language" height="16">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <!-- item-->
                    <a href="{{url('/language/ar')}}" data-appStyle="assets/css/app-rtl.min.css"
                       class="dropdown-item notify-item">
                        <img src="assets/images/flags/Egyptian.jpg" alt="user-image" class="mr-1" height="12"> <span
                                class="align-middle"> ِArabic </span>
                    </a>
                    <!-- item-->
                    <a href="{{url('/language/en')}}" class="dropdown-item notify-item">
                        <img src="assets/images/flags/us_flag.jpg" alt="user-image" class="mr-1" height="12"> <span
